...
with st.sidebar:
    ...
    if api_key:
        ...
        os.environ["OPENAI_API_KEY"] = api_key  # Set it as an environment variable
    ...
    if uploaded_file is not None:
        ...
        if "OPENAI_API_KEY" not in st.session_state:
            st.error("Please enter your OpenAI API Key before uploading the PDF.")
        else:
...
st.markdown(
    ...
    <div style="text-align: center;">
        <h1>Talk to your PDF using Agentic RAG</h1>
        <img src="data:image/png;base64,{}" width="120">
    </div>
    """.format(base64.b64encode(open("assets/crewai.png", "rb").read()).decode()),
